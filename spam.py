...
# Instagram- @strix_21
# YouTube- STRIX.D
# This tool is for educational purpose. Use at your own risk....
# ---------------------------------------------------------------
...
res = '\x1b[40m'
# -------------------------------------------------------
# A Python Program Using Object Oriented Programs
#------------------------Classes------------------------
class spam:
...
def logo():
	...
	# if you want to add variables and change data, Strix.D variables can add %s add a variable that keeps changing it to a string, %d = converting data to decimal , %i = converting data to an integer
	return '''
%s╲╲╲╲╲╲╲%s╔═╗╔═╗╔═╗╔╦╗
%s╲╲╲╲╲╲╲%s╚═╗╠═╝╠═╣║║║
%s╲╲╲╲╲╲╲%s╚═╝╩  ╩ ╩╩ ╩
